...
<table class="table table-striped table-hover table-bordered">
  ...
  include  'config.php';
   ...
   $q="select * from stu_courses where stu_id='$id'";
   //echo $q;
...
?>
  ...
  <tr class="text-center">
    ...
    <td><?php echo $res['teacher_mail']; ?></td>
    <td><?php echo $res['course_desc']; ?></td>
    ...
    video.php?id=<?php echo $res['id'];?>" class="
    text-white">Videos</a></button></td>
  </tr>
   <?php } ?>
</table>
</div>
